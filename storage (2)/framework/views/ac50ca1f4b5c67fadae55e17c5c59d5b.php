<?php echo $__env->make('frontend.layouts.filter_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('front_assets/css/filter.css')); ?>">
<div class="">
            ...
            <div class="OverallRating__Rating-y66epv-1 fkEGIy">
                <div class="OverallRating__RatingWrapper-y66epv-2 khkqiH">
                    ...
                    <div class="OverallRating__Number-y66epv-3 dXoyqn">
                        <?php echo e(number_format(($averageFacilities + $averageCoaching + $averageAtmosphere + $averageOverall) / 4, 1)); ?>
            ...
            <div class="SchoolSummary__SchoolSummaryContainer-pz83zp-1 kYvWmU mt-5">
                <div class="CategoryGrade__Row extradispay">
                    ...
                    <div class="CategoryGrade__CategoryGradeContainer-sc-17vzv7e-0 ivOAGg">
                        <img src="<?php echo e(asset('front_assets/images/banner/handshake-o.png')); ?>"
                        ...
                        <div class="GradeSquare__ColoredSquare-sc-6d97x2-0 eDqvVi"
                            style="background-color: <?php echo e(calculateColor($averageFacilities)); ?>">
                            <?php echo e(number_format($averageFacilities, 1)); ?>

                        </div>
                    </div>
                    <!-- Coaching -->
                    <div class="CategoryGrade__CategoryGradeContainer-sc-17vzv7e-0 ivOAGg">
                        <img src="<?php echo e(asset('front_assets/images/banner/user-circle-o.svg')); ?>"
                            class="CategoryGrade__CategoryIcon-sc-17vzv7e-2 cVGHd" />
                        <div class="CategoryGrade__CategoryTitle-sc-17vzv7e-1 XKroK">Coaching</div>
                        <div class="GradeSquare__ColoredSquare-sc-6d97x2-0 eDqvVi"
                            style="background-color: <?php echo e(calculateColor($averageCoaching)); ?>">
                            <?php echo e(number_format($averageCoaching, 1)); ?>
                ...
                <div class="CategoryGrade__Row extradispay">
                    ...
                    <div class="CategoryGrade__CategoryGradeContainer-sc-17vzv7e-0 ivOAGg">
                        <img src="<?php echo e(asset('front_assets/images/banner/awesome.svg.png')); ?>"
                            class="CategoryGrade__CategoryIcon-sc-17vzv7e-2 cVGHd" />
                        <div class="CategoryGrade__CategoryTitle-sc-17vzv7e-1 XKroK">Safety</div>
                        <div class="GradeSquare__ColoredSquare-sc-6d97x2-0 eDqvVi"
                            style="background-color: <?php echo e(calculateColor($averageAtmosphere)); ?>">
                            <?php echo e(number_format($averageAtmosphere, 1)); ?>

                        </div>
                    </div>
                    <!-- Communication | this was named Overall, renamed to Communication on 7/9)-->
                    <div class="CategoryGrade__CategoryGradeContainer-sc-17vzv7e-0 ivOAGg">
                        <img src="<?php echo e(asset('front_assets/images/banner/circle-notch.svg.png')); ?>"
                            class="CategoryGrade__CategoryIcon-sc-17vzv7e-2 cVGHd" />
                        <div class="CategoryGrade__CategoryTitle-sc-17vzv7e-1 XKroK">Communication</div>
                        <div class="GradeSquare__ColoredSquare-sc-6d97x2-0 eDqvVi"
                            style="background-color: <?php echo e(calculateColor($averageOverall)); ?>">
                            <?php echo e(number_format($averageOverall, 1)); ?>
...
<div data-ad-target="ratings-list" class="SchoolRatingsContainer__RatingsContainer-sc-1c1ilno-0 iXYxly">
    <div class="SchoolRatingsContainer__SchoolRatingsCount-sc-1c1ilno-1 jvHnvF">
        <?php echo e($numReviews); ?> Ratings
    </div>
<script>
    function updateLikesDislikes() {
        fetch('<?php echo e(route('freview.update.likes')); ?>', {
            method: 'GET',
            ...
            <li>
                        ...
                        <div class="SchoolRating__MainRatingContainer-sb9dsm-4 rASDq">
                            <div class="SchoolRating__RatingHeader-sb9dsm-5 yjiuU">
                                <div
                                    ...
                                    <?php echo e(optional($review->created_at)->format('Y-m-d')); ?>


                                </div>
                            </div>
                            <div class="SchoolRating__RatingComment-sb9dsm-6 eNyCKI"><?php echo e($review->feedback); ?></div>
                            <div>
                ...
                <?php if(auth()->check()): ?>
                    <div id="thumbs-id" class="Thumbs__ButtonWrapper-sc-19shlav-0 jsOpVQ thumbs">
                        <a href="javascript:void(0)" data-action="like" data-review-id="<?php echo e($review->id); ?>" class="likedislike" style="text-decoration: none">
                            <div id="thumbs_up" data-action="like" data-review-id="<?php echo e($review->id); ?>" class="Thumbs__ThumbContainer-sc-19shlav-1 jLESE ">
                                <div class="VoteThumb__StyledVoteContainer-p2gtch-1 grVCoH">
                                    <div class="VoteThumb__HelpfulText-p2gtch-2 biwTxB">Helpful</div>
                                    <img src="<?php echo e(asset('front_assets/images/banner/thumbs-up-black.eddae738.svg')); ?>" class="VoteThumb__StyledVoteThumb-p2gtch-0 hZbccg" data-tooltip="true" data-tip="Not helpful" data-for="GLOBAL_TOOLTIP" alt="Thumbs down" currentitem="false">
                                </div>
                                <div id="likes-count-<?php echo e($review->id); ?>" class="Thumbs__HelpTotalNumber-sc-19shlav-2 lihvHt likes-count"><?php echo e($review->likes()->sum('like')); ?></div>
                            </div>
                        </a>

                        <a href="javascript:void(0)" data-action="dislike" data-review-id="<?php echo e($review->id); ?>" class="likedislike" style="text-decoration: none">
                            <div id="thumbs_down" data-action="dislike" data-review-id="<?php echo e($review->id); ?>" class="Thumbs__ThumbContainer-sc-19shlav-1 jLESE ">
                                <div class="VoteThumb__StyledVoteContainer-p2gtch-1 grVCoH">
                                    <div class="VoteThumb__HelpfulText-p2gtch-2 biwTxB"></div>
                                    <img src="<?php echo e(asset('front_assets/images/banner/thumbs-down-black.bd601b36.svg')); ?>" class="VoteThumb__StyledVoteThumb-p2gtch-0 hZbccg" data-tooltip="true" data-tip="Not helpful" data-for="GLOBAL_TOOLTIP" alt="Thumbs down" currentitem="false">
                                </div>
                                <div id="dislikes-count-<?php echo e($review->id); ?>" class="Thumbs__HelpTotalNumber-sc-19shlav-2 lihvHt dislikes-count"><?php echo e($review->likes()->sum('dislike')); ?></div>
                            </div>
                        </a>
                    </div>
                <?php else: ?>
                    <div id="thumbs-id" class="Thumbs__ButtonWrapper-sc-19shlav-0 jsOpVQ thumbs">
                        <a href="javascript:void(0)" data-action="like" data-review-id="<?php echo e($review->id); ?>" class="" style="text-decoration: none" data-toggle="modal" data-target="#loginModal">
                            <div id="thumbs_up" data-action="like" data-review-id="<?php echo e($review->id); ?>" class="Thumbs__ThumbContainer-sc-19shlav-1 jLESE ">
                                <div class="VoteThumb__StyledVoteContainer-p2gtch-1 grVCoH">
                                    <div class="VoteThumb__HelpfulText-p2gtch-2 biwTxB">Helpful</div>
                                    <img src="<?php echo e(asset('front_assets/images/banner/thumbs-up-black.eddae738.svg')); ?>" class="VoteThumb__StyledVoteThumb-p2gtch-0 hZbccg" data-tooltip="true" data-tip="Not helpful" data-for="GLOBAL_TOOLTIP" alt="Thumbs down" currentitem="false">
                        ...
                        <a href="javascript:void(0)" data-action="dislike" data-review-id="<?php echo e($review->id); ?>" class="" style="text-decoration: none" data-toggle="modal" data-target="#loginModal">
                            <div id="thumbs_down" data-action="dislike" data-review-id="<?php echo e($review->id); ?>" class="Thumbs__ThumbContainer-sc-19shlav-1 jLESE ">
                                <div class="VoteThumb__StyledVoteContainer-p2gtch-1 grVCoH">
                                    <div class="VoteThumb__HelpfulText-p2gtch-2 biwTxB"></div>
                                    <img src="<?php echo e(asset('front_assets/images/banner/thumbs-down-black.bd601b36.svg')); ?>" class="VoteThumb__StyledVoteThumb-p2gtch-0 hZbccg" data-tooltip="true" data-tip="Not helpful" data-for="GLOBAL_TOOLTIP" alt="Thumbs down" currentitem="false">
                ...
                <?php endif; ?>
                                    ...
                                    <?php if(auth()->check()): ?>
                                    <a id="reportFlag-<?php echo e($review->id); ?>"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="reportModalLabel">Report a Rating for
                                                        <strong
                                                            style="color:#000; font-weight:600;"><?php echo e($gym->name); ?></strong>
                                                    </h5>
                                               ...
                                               <form id="report-form-<?php echo e($review->id); ?>" action="<?php echo e(route('freview.report')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <div class="modal-body">
                                                    ...
                                                    <p>If you think this comment is inconsistent with Rate My Cheer Gym' <a href="<?php echo e(route('guidelines')); ?>"><b>Site Guidelines</b></a>,
                                                    ...
                                                    <textarea name="report" id="reportText-<?php echo e($review->id); ?>" class="form-control" rows="4"
                                                ...
                                                <div class="modal-footer">
                                                    <button type="submit" class="btn reportBtn" id="submitBtn-<?php echo e($review->id); ?>">Submit</button>
                                                    <br>
                                                    <button type="button" class="btn btn-secondary cancelbtn" data-dismiss="modal" id="cancelBtn-<?php echo e($review->id); ?>">Cancel</button>
                                                </div>
                                            </form>

<script>
document.getElementById('report-form-<?php echo e($review->id); ?>').addEventListener('submit', function(event) {
...
document.getElementById('cancelBtn-<?php echo e($review->id); ?>').addEventListener('click', function() {
        ...
        confirmButtonText: 'OK'
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            $('#reportFlag-<?php echo e($review->id); ?>').on('click', function(event) {
                                                event.preventDefault();
                                                $('#reportModal-<?php echo e($review->id); ?>').modal('show');
                                            });

                                            $('#reportText-<?php echo e($review->id); ?>').on('input', function() {
...
<script>
    $(document).on('click', '.likedislike', function() {
        ...
        fetch('<?php echo e(route('freview.like')); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('frontend.layouts.filter_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
