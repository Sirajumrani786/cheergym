...
<head>
    ...
    <meta itemprop="description"
        content="Black Dashboard PRO is a beautiful Bootstrap 4 admin dashboard with a large number of components, designed to look beautiful, clean and organized. If you are looking for a tool to manage dates about your business, this dashboard is the thing for you.">
    <meta itemprop="image"
        content="<?php echo e(asset('s3.amazonaws.com/creativetim_bucket/products/93/opt_bd_thumbnail.jpg')); ?>">
    ...
    <link href="<?php echo e(asset('use.fontawesome.com/releases/v5.0.6/css/all.css')); ?>" rel="stylesheet">

    <link href="<?php echo e(asset('assets/css/nucleo-icons.css')); ?>" rel="stylesheet" />

    <link href="<?php echo e(asset('assets/css/black-dashboard.min3f71.css?v=1.1.1')); ?>" rel="stylesheet" />
    ...
    <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
        <div class="container-fluid">
            <div class="navbar-wrapper">
                ...
                <a class="navbar-brand" href="<?php echo e(route('dashboard')); ?>">RATE MY CHEER GYM - Dashboard</a>
            </div>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="dropdown nav-item">
                        <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                            <div class="photo">
                                <img src="<?php echo e(auth()->user()->profile ? asset(auth()->user()->profile) : asset('assets/img/placeholder.jpg')); ?>"
                                    alt="Profile Photo">
                            </div>
...
<?php /**PATH D:\Softwe\laragon\www\gym website code\gym-Website\resources\views//includes/header.blade.php ENDPATH**/ ?>