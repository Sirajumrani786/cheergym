...
<!-- Mirrored from colorlib.com/etc/lf/Login_v13/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 May 2024 12:43:36 GMT -->

<head>
    <title>Fitness Gym Register</title>
    <meta charset="UTF-8">
    ...
    <link rel="stylesheet" type="text/css" href="asset_login/fonts/iconic/css/material-design-iconic-font.min.css">
...
<body style="background-color: #999999;">
    <div class="limiter">
        <div class="container-login100">
            <div class="login100-more" style="background-image: url('front_assets/images/banner/img_03.png');">
                <a href="{{ route('index') }}" class="main__logo">
                    <img src="front_assets/images/logo/logo.png" alt="logo__image"
            ...
            <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                <form class="login100-form validate-form" method="post" action="{{route('user.register')}}">
                    ...
                    <div class="container-login100-form-btn">
                        ...
                        <a href="{{ route('flogin') }}" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
                            Sign in
                            <i class="fa fa-long-arrow-right m-l-5"></i>
                        </a>
                         <div class="google-login-container">
                            <a href="#" class="login100-form-btn-google">
                                <span><img src="front_assets/images/banner/google.jpg"  style="width: 8%;border-radius: 20px;">  Login with Google</span>
                            </a>
                        </div>
                    </div>
                </form>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vedd3670a3b1c4e178fdfb0cc912d969e1713874337387"
        ...
        data-cf-beacon='{"rayId":"887ce4873ea7602f","b":1,"version":"2024.4.1","token":"cd0b4b3a733644fc843ef0b185f98241"}'
        crossorigin="anonymous"></script>
</body>

<!-- Mirrored from colorlib.com/etc/lf/Login_v13/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 May 2024 12:43:46 GMT -->
