...
<link rel="stylesheet" href="{{asset('front_assets/css/gymrating.css')}}">
    ...
    <title data-react-helmet="true">Rate My Cheer Gym</title>
                        ...
                        <div class="cta-button">
                            ...
                            <a href="{{ route('user_pannel') }}" class="menbtn">HEY, {{ Auth::user()->name}}</a>
                                <div class="dropdown-content">
                                    ...
                                    <a href="{{ route('user_pannel') }}"
                                        onclick="showSection('account-settings')">Account Settings</a>
                                    <a href="{{ route('user_pannel') }}" onclick="showSection('ratings')">Your
                                        Ratings</a>
                    ...
                    <div class="StickyHeader__StyledStickyHeader-sc-19g16mb-1 hyZQlh">
                        <div class="StickyHeader__StyledSecondaryContainerOne-sc-19g16mb-2 cBsYhh">
                            <div class="HeaderDescription__StyledInfoContainer-sc-1lt205f-0 eGhbZq"><span
                                    class="HeaderDescription__StyledCityState-sc-1lt205f-2 cyDJfW">{{$review->gym->location}}                                   </span>
