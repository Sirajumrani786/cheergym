                            ...
                            <div class="search-bar">
                                <form action="{{ route('search') }}" method="get">
                                    <input type="text" name="keyword" placeholder="Your Gym"
                                        style="border-radius: 34px; border: 1px solid #ced4da; width: 780px; padding: 12px 17px;">
                                </form>
                            </div>
                            <div class="cta-button">
                                @if (Auth::check())
                                    <a href="{{ route('user_pannel') }}" class="menbtn">HEY,
                                        {{ Auth::user()->name }}</a>
                                    <div class="dropdown-content">
                                        <a href="{{ route('user_pannel') }}"
                                            onclick="showSection('profile')">Profile</a>
                                        <a href="{{ route('user_pannel') }}"
                                            onclick="showSection('account-settings')">Account
                                            Settings</a>
                                        <a href="{{ route('user_pannel') }}" onclick="showSection('ratings')">Your
                                            Ratings</a>
                                        <a href="{{ route('user_pannel') }}"
                                            onclick="showSection('saved-professors')">Saved
                                            Gyms</a>
                                ...
                                @else
                                    <button type="button" class="menbtn" data-toggle="modal"
