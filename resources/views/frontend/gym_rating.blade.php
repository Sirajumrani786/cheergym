  ...
  <div class="accordion-container">
    ...
    margin-top: 2px;">
      ...
      <div class="accordion-content">
        ...
        <a href="{{route('guidelines')}}" style="color: #000;text-decoration: underline; font-weight: 600;">View all guidelines</a>
      </div>
    </details>
  </div>
  ...
  <script>
    ...
    document.querySelectorAll("details").forEach((el) => {
      new Accordion(el);
                ...
                <p>By clicking the "Submit" button, I acknowledge that I have read and agreed to the Rate My Cheer Gym's <a href="{{route('guidelines')}}">Site Guidelines</a>, <a href="{{route('terms')}}">Terms of Use</a>, and <a href="{{route('privacy')}}">Privacy Policy</a>. Submitted data becomes the property of Rate My Cheer Gym, LLC.</p>
