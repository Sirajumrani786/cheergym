    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-header">
                    <h5 class="title">Edit Main Page Images</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('mainpage.update', $mainPage->id) }}" method="POST"
                        ...
                        <div class="col-md-12 col-sm-12 pull-right text-center">
                        ...
                        <div class="col-md-4 col-sm-12 pull-right text-center">
                            ...
                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                <div class="fileinput-new thumbnail">
                                    <img src="{{ $mainPage->placeholder_img_1 ? asset($mainPage->placeholder_img_1) : asset('../../assets/img/image_placeholder.jpg') }}"
                                        alt="{{ $mainPage->placeholder_img_1 }}">
                                </div>
                                <div class="fileinput-preview fileinput-exists thumbnail"></div>
                                <div>
                                    <span class="btn btn-rose btn-round btn-file">
                        ...
                        <div class="col-md-4 col-sm-12 pull-right text-center">
                            ...
                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                <div class="fileinput-new thumbnail">
                                    <img src="{{ $mainPage->placeholder_img_2 ? asset($mainPage->placeholder_img_2) : asset('../../assets/img/image_placeholder.jpg') }}"
                                        alt="{{ $mainPage->placeholder_img_2 }}">
                                </div>
                                <div class="fileinput-preview fileinput-exists thumbnail"></div>
                                <div>
                                    <span class="btn btn-rose btn-round btn-file">
                        ...
                        <div class="col-md-4 col-sm-12 pull-right text-center">
                            ...
                            <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                <div class="fileinput-new thumbnail">
                                    <img src="{{ $mainPage->placeholder_img_3 ? asset($mainPage->placeholder_img_3) : asset('../../assets/img/image_placeholder.jpg') }}"
                                        alt="{{ $mainPage->placeholder_img_3 }}">
                                </div>
                                <div class="fileinput-preview fileinput-exists thumbnail"></div>
                                <div>
                                    <span class="btn btn-rose btn-round btn-file">
