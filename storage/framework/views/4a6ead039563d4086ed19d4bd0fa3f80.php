...
<head>
    <!-- Google Tag Manager NICK ADDED THIS-->
    ...
    <link rel="stylesheet" href="<?php echo e(asset('front_assets/css/gymrating.css')); ?>">
    ...
    <title data-react-helmet="true">Rate My Cheer Gym | Rating</title>
...
<!--NICK    <div id="div-gpt-ad-1579103811294-0">
        <script>
            googletag.cmd.push(function() {
...
<body>
    ...
    <!-- Google Tag Manager (noscript) NICK ADDED THIS -->
            ...
            <div class="App__Body-aq7j9t-1 bhyGpW">
                <header>
                    <div class="header-container">
                        <h1 class="logo"><a href="<?php echo e(route('index')); ?>">RMCG</a></h1>
                        <div class="search-bar">
                            <form action="<?php echo e(route('search')); ?>" method="get">
                                <input type="text" name="keyword" placeholder="Your Gym"
                                    style="border-radius: 34px; border: 1px solid #ced4da; width: 660px; padding: 12px 17px;">
                            </form>
                        </div>
                          <div class="cta-button">
                            <?php if(Auth::check()): ?>
                            <a href="<?php echo e(route('user_pannel')); ?>" class="menbtn">Hey, <?php echo e(Auth::user()->name); ?></a>
                                <div class="dropdown-content">
                                    <a href="<?php echo e(route('user_pannel')); ?>" onclick="showSection('profile')">Profile</a>
                                    <a href="<?php echo e(route('user_pannel')); ?>"
                                        onclick="showSection('account-settings')">Account Settings</a>
                                    <a href="<?php echo e(route('user_pannel')); ?>" onclick="showSection('ratings')">Your
                                        Ratings</a>
                                    <a href="<?php echo e(route('user_pannel')); ?>" onclick="showSection('saved-professors')">Saved
                                        Gyms</a>
                    ...
                    <div class="StickyHeader__StyledStickyHeader-sc-19g16mb-1 hyZQlh">
                        <div class="StickyHeader__StyledSecondaryContainerOne-sc-19g16mb-2 cBsYhh">
                            <div class="HeaderDescription__StyledInfoContainer-sc-1lt205f-0 eGhbZq"><span
                                    class="HeaderDescription__StyledCityState-sc-1lt205f-2 cyDJfW"><?php echo e($gym->location); ?></span>
                                <div class="HeaderDescription__StyledTitleName-sc-1lt205f-1 eNxccF">
                                    <div>
                                        ...
                                        </div><span> <?php echo e($gym->name); ?></span>
                                    </div>
                                </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div id="loginForm">
                            ...
                            <button class="oauth-button mb-4" type="button">
                                <img src="<?php echo e(asset('front_assets/images/banner/google.jpg')); ?>" alt="Google"
                        ...
                        <div id="registrationForm" style="display: none;">
                            ...
                            <form method="post" action="<?php echo e(route('user.register')); ?>" id="registrationForm">
                                <?php echo csrf_field(); ?>
                                <div class="form-group">
                                    <div class="input-field">
...
</script><?php /**PATH D:\Softwe\laragon\www\gym website code\gym-Website\resources\views/frontend/layouts/gym_rating_header.blade.php ENDPATH**/ ?>