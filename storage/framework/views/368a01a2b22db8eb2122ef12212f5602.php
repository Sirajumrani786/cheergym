    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="login100-more" style="background-image: url('front_assets/images/banner/img_03.png');">
                <a href="<?php echo e(route('index')); ?>" class="main__logo">
                    <img src="front_assets/images/logo/logo.png" alt="logo__image" style="width: 20% !important; margin-top: 20px;">
                </a>
            </div>
            <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                <form class="login100-form validate-form" action="<?php echo e(route('user.login')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="container-login100-form-btn">
                        ...
                        <a href="<?php echo e(route('fregister')); ?>" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
                            Sign Up
                            <i class="fa fa-long-arrow-right m-l-5"></i>
                        </a>
                        <!-- Centered Google Login Icon -->
...
<?php /**PATH D:\Softwe\laragon\www\gym website code\gym-Website\resources\views/frontend/flogin.blade.php ENDPATH**/ ?>