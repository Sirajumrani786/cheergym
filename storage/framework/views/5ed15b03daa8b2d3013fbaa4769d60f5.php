...
li.term_li {
    ...
    <body>
        ...
        <header style="background: linear-gradient(to bottom, black, #464141);">
            <div class="container">
                <div class="row">
                    <a href="<?php echo e(url('/')); ?>" class="logo"><img src="<?php echo e(asset('front_assets/img/logo.png')); ?>" alt></a>
        ...
        </header><?php /**PATH D:\Softwe\laragon\www\gym website code\gym-Website\resources\views/frontend/layouts/headertwo.blade.php ENDPATH**/ ?>